"""run_phenom.py — scrape all active Phenom People sources end-to-end."""
...
# Support running as: python jobs_pipeline/run_phenom.py from project root
...
def main():
    ...
    print(f"Phenom scrape starting at {start}")

    sources = get_active_sources(PLATFORM)
    print(f"Found {len(sources)} active Phenom sources")
