"""run_lever.py — scrape all active Lever sources end-to-end."""
...
# Support running as: python jobs_pipeline/run_lever.py from project root
...
def main():
    ...
    print(f"Lever scrape starting at {start}")

    sources = get_active_sources(PLATFORM)
    print(f"Found {len(sources)} active Lever sources")
