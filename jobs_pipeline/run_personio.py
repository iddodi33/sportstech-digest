"""run_personio.py — scrape all active Personio sources end-to-end."""
...
# Support running as: python jobs_pipeline/run_personio.py from project root
...
def main():
    ...
    print(f"Personio scrape starting at {start}")

    sources = get_active_sources(PLATFORM)
    print(f"Found {len(sources)} active Personio sources")
