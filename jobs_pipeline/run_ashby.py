"""run_ashby.py — scrape all active Ashby sources end-to-end."""
...
# Support running as: python jobs_pipeline/run_ashby.py from project root
...
def main():
    ...
    print(f"Ashby scrape starting at {start}")

    sources = get_active_sources(PLATFORM)
    print(f"Found {len(sources)} active Ashby sources")
