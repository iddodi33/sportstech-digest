"""run_teamtailor.py — scrape all active Teamtailor sources end-to-end."""
...
# Support running as: python jobs_pipeline/run_teamtailor.py from project root
...
def main():
    ...
    print(f"Teamtailor scrape starting at {start}")

    sources = get_active_sources(PLATFORM)
    print(f"Found {len(sources)} active Teamtailor sources")
