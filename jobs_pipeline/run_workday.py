"""run_workday.py — scrape all active Workday sources end-to-end."""
...
# Support running as: python jobs_pipeline/run_workday.py from project root
...
def main():
    ...
    print(f"Workday scrape starting at {start}")

    sources = get_active_sources(PLATFORM)
    print(f"Found {len(sources)} active Workday sources")
