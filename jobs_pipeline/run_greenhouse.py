"""run_greenhouse.py — scrape all active Greenhouse sources end-to-end."""
...
# Support running as: python jobs_pipeline/run_greenhouse.py from project root
...
def main():
    ...
    print(f"Greenhouse scrape starting at {start}")

    sources = get_active_sources(PLATFORM)
    print(f"Found {len(sources)} active Greenhouse sources")
