"""run_bamboohr.py — scrape all active BambooHR sources end-to-end."""
...
# Support running as: python jobs_pipeline/run_bamboohr.py from project root
...
def main():
    ...
    print(f"BambooHR scrape starting at {start}")

    sources = get_active_sources(PLATFORM)
    print(f"Found {len(sources)} active BambooHR sources")
