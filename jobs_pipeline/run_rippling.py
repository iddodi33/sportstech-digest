"""run_rippling.py — scrape all active Rippling sources end-to-end."""
...
# Support running as: python jobs_pipeline/run_rippling.py from project root
...
def main():
    ...
    print(f"Rippling scrape starting at {start}")

    sources = get_active_sources(PLATFORM)
    print(f"Found {len(sources)} active Rippling sources")
